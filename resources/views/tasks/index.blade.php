                                ...
                                <div class="collapse navbar-collapse text-center" id="navbarsExample11">
                                    <ul class="navbar-nav">
                                        <li class="nav-item active">
                                            <small><a class="nav-link" href="/tasks">لیست تفکیکی</a></small>
                                        </li>
{{--                                        <li class="nav-item">--}}
...
{{--                                        </li>--}}
                                        <li class="nav-item">
                                            <small><a class="nav-link" href="/tasks?sort=012">لیست کارها</a></small>
                                        </li>
                                        <li class="nav-item">
...
{{--                            @endif--}}
    ...
    <h6 class="display-6 text-center text-muted animated fadeIn delay-1s" data-toggle="collapse" data-target="#routineTasks" style="cursor: pointer">کارهای روتین</h6>
{{--        <hr class="d-inline-block my-4 animated fadeIn delay-1s w-25">--}}

    </div>
<div class="collapse show" id="routineTasks">
...
@endif
                        ...
                        @endif
                        @if(count($order1) > 0 && !isset($_GET['sort']))

                        <div class="bg-light pt-3" style="border-radius: 20px">
                        <div class="page-header">
                            <h6 class="display-6 text-center text-muted animated fadeIn delay-1s">در حال انجام <small class="badge badge-light">{{count($order1)}}</small></h6>
                        </div>
                        @foreach($order1 as $o)
                        ...
                        @endif
                        @if(count($order0) > 0 && !isset($_GET['sort']))
<div class="bg-light " style="border-radius: 20px">
    <div class="page-header py-3">

    <h6 class="display-6 text-center text-muted anmated fadeIn delay-1s" data-toggle="collapse" data-target="#waitingTasks" style="cursor: pointer">کارهای در انتظار <small class="badge badge-light">{{count($order0)}}</small></h6>

    </div>
                        <div class="collapse" id="waitingTasks">
                        ...
                        @endif
                        @if(isset($_GET['sort']) && $_GET['sort'] == '012')
                            @foreach($order012 as $o)
...
@endif
                        ...
                        @endif
                        @if(count($order3) > 0 && isset($_GET['sort']) && $_GET['sort'] == 'done')
                        <div class="">
                            <h4 class="display-6 text-muted text-center animated fadeIn delay-1s" data-toggle="collapse" data-target="#endedTasks" style="cursor: pointer">کارهای پایان یافته</h4>
                            <div class="collapse show" id="endedTasks">
...
{{--                                                    </div>--}}
                            ...
                            {{ $order3->appends(['sort' => 'done'])->links() }}
