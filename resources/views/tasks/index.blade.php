...
<div class="jumbotron ">
    <h4 class="display-6 text-muted text-center animated fadeIn delay-1s" data-toggle="collapse" data-target="#routineTasks" style="cursor: pointer">کارهای روتین <small class="badge badge-light">{{count($orderRoutine)}}</small></h4>

<div class="collapse" id="routineTasks">
...
@endif
                        ...
                        @endif
                        <h1 class="display-6 text-muted text-center animated fadeIn delay-1s">در حال انجام <small class="badge badge-light">{{count($order1)}}</small></h1>
                        <hr class="my-4 animated fadeIn delay-1s">
                        @foreach($order1 as $o)
                        ...
                        @endforeach
<div class="jumbotron">
                        <h4 class="display-6 text-muted text-center animated fadeIn delay-1s" data-toggle="collapse" data-target="#waitingTasks" style="cursor: pointer">کارهای در انتظار <small class="badge badge-light">{{count($order0)}}</small></h4>
                        ...
                        <div class="jumbotron">
                            <h4 class="display-6 text-muted text-center animated fadeIn delay-1s" data-toggle="collapse" data-target="#endedTasks" style="cursor: pointer">کارهای پایان یافته <small class="badge badge-light">{{count($order3)}}</small></h4>
                            <div class="collapse" id="endedTasks">
                                <hr class="my-4 animated fadeIn delay-1s">
